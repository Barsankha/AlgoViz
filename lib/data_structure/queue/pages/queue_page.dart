...
import 'package:algov/data_structure/queue/widgets/queue_visualizer.dart';
...
class QueueAlgoVisPage extends StatefulWidget {
  const QueueAlgoVisPage({super.key});

  @override
  State<QueueAlgoVisPage> createState() => _QueueAlgoVisPageState();
}

class _QueueAlgoVisPageState extends State<QueueAlgoVisPage> {
  @override
  Widget build(BuildContext context) {
    final size = MediaQuery.sizeOf(context);
    final isCompact = size.shortestSide < 600;
    final bool isdark = context.read<AppBloc>().state.theme == AppTheme.dark;
    final stackRepo = AlgorithmRepository.queueAlgo[0];
    return Material(
